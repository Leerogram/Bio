...
import com.green.controller.UserController;
...
public class unitTest_JPA {
    ...
    public void joinTest() throws Exception {
        ...
        users.setEMAIL("bootJpaTester1");
        users.setPASSWD("bootJpaTester1");
        users.setEMAIL("bootJpaTester1");
        users.setREG_DATE(LocalDateTime.now());
        users.setUSERROLE("user");
        //when
        mock.perform(MockMvcRequestBuilders.get("/").contentType(MediaType.APPLICATION_JSON))
